...
\begin{tabular}{r L{8.5cm} l}
	...
	\makecell{2019 \\ \phantom{.}}  & IEEE Workshop on adding WiFi to your projects using ESP8266 and MQTT  & \makecell{SPIT, Mumbai \\ \phantom{.}}   \\
	
	2019	  & Teaching Assistantship: Robotic Vision  & SPIT, Mumbai   \\
	
	\makecell{2018 \\ \phantom{.}}	  & IEEE Workshop on Introduction to Microcontrollers, Sensors and Arduino  & \makecell{SPIT, Mumbai \\ \phantom{.}}   \\
	
	2018	  & Workshop on Introduction to Embedded Systems Design  & SPIT, Mumbai   \\
	
	\makecell{2016 \\ \phantom{.}}	  & Robocon Workshop on PCB making and basics of a robotic system  & \makecell{SPIT, Mumbai \\ \phantom{.}}   \\
\end{tabular}
\sectionsep
...
\descript{| UPennX, edX - Certificate \href{https://courses.edx.org/certificates/c152ee504c954a208a262c2fafe5aca3}{ \faExternalLink}}
\location{Oct 2018}
